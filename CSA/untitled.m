...
%   ����������λ��IFFT���ص�ͼ���򣬳��������
%
% �������޸Ľ�ֹ���� 2014.10.19. 13:53 p.m.
%
% ע���޸ĺ�ĳ����У���Ҫ�Ǹ�����һ������ԭʼ���ݽ��в��㣬�ٽ��к���������
...
if b == 1
    load CDdata1 data;                % ����1������
    s_echo = data;            % ԭʼ���ݼ�Ϊs_echo�����ں�������
end
clear CDdata1;                   % ���data_1�����ڳ��ڴ�

if b == 2
    load CDdata2;                % ����2������
    s_echo = data_2;            % ԭʼ���ݼ�Ϊs_echo�����ں�������
end
clear CDdata2;                   % ���data_2�����ڳ��ڴ�
...
clear CDdata1;clear CDdata2;clear s_echo1;clear s_echo2;
